...
alter table public.profiles add column if not exists theme_preference text not null default 'dark' check (theme_preference in ('dark', 'light', 'system'));
...
create table if not exists public.properties (
  ...
  property_type text not null default 'Modern Luxury',
