...
function corsHeaders(request) {
  ...
  return {
    ...
    'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' wasm-unsafe-eval https://ajax.googleapis.com https://maps.googleapis.com blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: blob: https:; connect-src 'self' data: blob: https://*.supabase.co wss://*.supabase.co https://maps.googleapis.com https://fonts.googleapis.com https://fonts.gstatic.com https://ajax.googleapis.com https://sketchfab.com https://*.sketchfab.com https://api.emailjs.com; media-src 'self' data: blob: https:; frame-src 'self' https://sketchfab.com https://*.sketchfab.com https://maps.googleapis.com https://*.google.com; worker-src 'self' blob:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self';",
